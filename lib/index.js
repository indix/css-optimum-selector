...
var CssOptimumSelector = function (_CssOptimumSelectorHe) {
  ...
  function CssOptimumSelector() {
    _classCallCheck(this, CssOptimumSelector);

    return _possibleConstructorReturn(this, (CssOptimumSelector.__proto__ || Object.getPrototypeOf(CssOptimumSelector)).apply(this, arguments));
  }
  ...
  _createClass(CssOptimumSelector, [{
    ...
    value: function multiSelector(firstElement, secondElement) {
      ...
      return getMultiSelector((0, _jquery2.default)(firstElement), (0, _jquery2.default)(secondElement));
    }
  }]);
